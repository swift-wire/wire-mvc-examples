...
A feature-by-feature tour of the examples: what each one demonstrates, why it is arranged the way
it is, and what the arrangement rules out. The [README](../../README.md) says which packages exist
and where to look; this says what there is to see.
